...
int main(int argc, char const *argv[]) {
    { // Character manipulation
        ...
        std::cout << "-----------CHARACTER MANIPULATION-----------------";
        std::cout << std::endl;
        ...
        std::cout << " ^ is alphabetic : " << std::isalpha('^')
                  << std::endl; // -1
        std::cout << " 6 is alphabetic : " << std::isalpha('7')
                  << std::endl; // 0
        ...
        std::cout << " In total we found " << blank_count
                  << " blank characters." << std::endl;

        // Check if character is lowercase or uppercase
        std::cout << "-> std::islower and std::isupper: " << std::endl;

        char thought[]{"The C++ Programming Language is one of the most used "
                       "on the Planet"};
        ...
        std::cout << std::endl;
        std::cout << " Found " << lowercase_count
                  << " lowercase characters and " << upppercase_count
                  << " uppercase characters." << std::endl;

        // Check if a character is a digit
        std::cout << "-> std::isdigit : " << std::endl;

        char statement[]{"Mr Hamilton owns 220 cows. That's a lot of cows! The "
                         "kid exclamed."};
        ...
        std::cout << " Found " << digit_count
                  << " digits in the statement string" << std::endl;
        ...
        // for (auto character : original_str) // This copies the character of
        // original_str and applies opeartion to it.
        {
            if (std::islower(character))
    ...
    { // C-String Manipulation
        ...
        std::cout << "-> size and strlen on strings: " << std::endl;
        ...
        std::cout << " std::size(message1) : " << std::size(message1)
                  << std::endl;
        ...
        // std::strcmp - signature : int strcmp( const char *lhs, const char
        // *rhs ); Returns negative value if lhs appears before rhs in
        // lexicographical order, Zero if lhs and rhs compare equal. and
        ...
        // std::strncmp : int strncmp( const char *lhs, const char *rhs,
        // std::size_t count ); Compares n characters in the strings Returns :
        ...
        std::cout << " std::strncmp (" << string_data1 << "," << string_data2
                  << "," << n << ") : "
                  << std::strncmp(string_data_comp1, string_data_comp2, n)
                  << std::endl;

        string_data_comp1 = "aaaia";
        string_data_comp2 = "aaance";

        std::cout << " std::strncmp (" << string_data_comp1 << ","
                  << string_data_comp2 << "," << n << ") : "
                  << std::strncmp(string_data_comp1, string_data_comp2, n)
                  << std::endl;
        ...
        std::cout << " std::strncmp (" << string_data_comp3 << ","
                  << string_data_comp4 << "," << n << ") : "
                  << std::strncmp(string_data_comp3, string_data_comp4, n)
                  << std::endl;
        ...
        while ((result_new = std::strchr(str_new, target_new)) != nullptr) {
            std::cout << " Found '" << target_new << "' starting at '"
                      << result_new << "'\n";
        ...
        if (output)
            std::cout << " " << output + 1
                      << std::endl; //+1 because we want to start printing past
    ...
    }
    {
        ...
        std::strcat(
            dest,
            src); // Some compilers (MSVC) think these functions are unsafe!
        std::cout << " dest : " << dest << std::endl; // Hello World
        std::strcat(dest, ", Goodbye World!");
        std::cout << " dest : " << dest
                  << std::endl; // Hello World, Goodbye World!

        char *dest1 =
            new char[30]{'F', 'i', 'r', 'e', 'l', 'o', 'r', 'd', '\0'};
        char *source1 =
            new char[31]{',', 'T', 'h', 'e', ' ', 'P', 'h', 'o', 'e', 'n',
                         'i', 'x', ' ', 'K', 'i', 'n', 'g', '!', '\0'};

        // NOTE TO SELF :
        // Describe what's going to happen in std::strcat before you do the cat
        // : source is going to be appended to dest, and the process will start
        ...
        // signature : char *strncat( char *dest, const char *src, std::size_t
        // count );
        std::cout << std::endl;
        ...
        char *dest3 =
            new char[std::strlen(source3) + 1]; // +1 for the null character
        ...
        // signature : char *strncpy( char *dest, const char *src, std::size_t
        // count );
        std::cout << std::endl;
