...
int main(int argc, char const *argv[]) {
    {
        ...
        std::string prefered_planet{
            planet}; // Initialize with other existing string
        std::string prefered_planet_2(
            planet_2); // Initialize with other existing string
        std::string message{"Hello there", 5}; // Initialize with part of a
                                               // string literal. Contains hello
        std::string message_2("Hello there",
                              5); // Initialize with part of a string literal.
        std::string weird_message(
            4, 'e'); // Initialize with multiple copies of a char
                     //  contains eeee
        std::string weird_message_2{
            4, 'e'}; // Initialize with multiple copies of a char
                     //  contains eeee
    ...
    }
    {
        ...
        // String literals are expanded into const char* arrays and C++ doesn't
        // know how to add arrays with the + operator. Hence the compiler error.
        ...
        std::cout << " A few ways around string literal concatenation"
                  << std::endl;
        ...
        std::string str8{std::string("Hello") +
                         " World"}; // Turn one or both into a std::string
                                    // object  and do the concatenation
        ...
        using namespace std::string_literals; // necessary for the s suffix
                                              // This polutes the namespace in
                                              // main
        std::string str9{"Hello"s +
                         " World"}; // Turn one or both into strings using the
                                    // s suffix . the string_literals namespace
        ...
        std::cout << "-> Append method can do more than + operator: "
                  << std::endl;
        ...
        std::string str18{str17.append(
            str16, 4, 5)}; // Append a sub-section of another string
        ...
        std::string str22{str20 + ' ' +
                          str21}; // The space in between is a character
        ...
        // Another solution
        std::string str24 =
            "Hello"; // Take out the , and space we added before.
        ...
        std::cout << " + C-String: " << std::string{"Hello "} + message2
                  << std::endl;
        std::cout << " append char array : "
                  << std::string{"Hello "}.append(message1) << std::endl;
        std::cout << " append C-String : "
                  << std::string{"Hello "}.append(message2) << std::endl;

        // Concatenating std::strings and numbers
        std::cout << "-> Concatenating numbers using to_string()\n";
    ...
    { // Accessing Characters in the string
        ...
        // Getting the front and back characters and modify directly using
        // referecnces. const references will not work.
        ...
        std::cout << " Wrapped c string (after modification) : " << data
                  << std::endl;
        std::cout << " Original string (after modification ) :" << str7
                  << std::endl;
    }
    { // std::string size and capacity

        std::cout << "-> String Size and Capacity";
        ...
        std::cout << "  str1 is empty : " << std::boolalpha << str1.empty()
                  << std::endl;
        std::cout << "  str2 is empty : " << std::boolalpha << str2.empty()
                  << std::endl;
        std::cout << "  str3 is empty : " << std::boolalpha << str3.empty()
                  << std::endl;

        // Size
        std::cout << " std::string::size() : " << std::endl;
        std::cout << "  str1 contains " << str1.size() << " characters"
                  << std::endl; // 11
        std::cout << "  str2 contains " << str2.size() << " characters"
                  << std::endl; // 0
        std::cout << "  str3 contains " << str3.size() << " characters"
                  << std::endl; // 0

        // Length
        std::cout << " std::string::length() : " << std::endl;
        std::cout << "  str1 contains " << str1.length() << " characters"
                  << std::endl; // 11
        std::cout << "  str2 contains " << str2.length() << " characters"
                  << std::endl; // 0
        std::cout << "  str3 contains " << str3.length() << " characters"
                  << std::endl; // 0
        ...
        std::cout << " std::string can hold " << str4.max_size()
                  << " characters" << std::endl;
        ...
        str6 = "The sky is so blue, the grass is green. Kids are running all "
               "over the place";
        ...
        std::cout << "  str7 capacity : " << str7.capacity()
                  << std::endl; // 100
        std::cout << "  str7 size : " << str7.size() << std::endl;
    ...
    { // Modify std::strings
        ...
        std::cout << "-> Clear and Insert method\n";
        ...
        // Insert (3)
        //(3)basic_string& insert( size_type index, const CharT* s, size_type
        // count );
        // Inserts the characters in the range [s, s+count) at the position
        ...
        std::string str9{"Hello World is a message used to start off things "
        ...
        // Reset str9.
        str9 = "Hello World is a message used to start off things when "
               "learning programming!";

        // Direct print out.Because this method returns a reference to the
        // modified string
    ...
    { // Compare std::strings
        ...
        std::cout << " " << hello_str << "==" << c_string1
                  << " (C-String) : " << (hello_str == c_string1)
                  << std::endl; // false
        std::cout << " " << c_string1 << " (C-String) ==" << hello_str << " : "
        ...
        hello_str = "hello";
        // const char hello_char_array[] {'h','e','l','l','o'}; //The compiler
        // is going to read past the string until it sees a null character and
        // consider that end of the string. Your comparisons may give erronous
        // results

        const char hello_char_array[]{
            'h', 'e', 'l',
            'l', 'o', '\0'}; // It works right if you put the '\0' yourself
        std::cout << hello_str << " == hello_char_array : "
                  << (hello_str == hello_char_array) << std::endl;
    }
    {
        // Compare (1)
        ...
        // ) const; (2) Compares a  substring  of this string(from pos1, going
        // count1 positions) to str
        std::string str3 = "Hello";
        std::string str4{"Hello World"};
        std::cout << " Comparing 'World' to 'Hello' : "
                  << str4.compare(6, 5, str3) << std::endl; // 1

        // Compare (3)
        // int compare( const CharT* s ) const;(4)
        // Compares this string to the null-terminated character sequence
        // beginning at the character pointed to by s.
        std::string str5{"Hello"};
        const char *message{"World"};
        std::cout << " Comparing Hello to World : " << str5.compare(message)
                  << std::endl; //-1
    ...
    }
    {
        ...
        // basic_string& str ); Replace the range [pos, pos + count] with str
        std::cout << "-> Replace/Copy method\n";
        std::string str1{
            "Finding Nemo"}; // Replace Finding with 'Searching For'
        ...
        std::string str3{
            "The Horse was Found in the Fields Searching For Food"};
        ...
        char txt4[15]{}; // Initialized with zero equivalent for characters
                         // which is '\0'
        ...
        str5.resize(
            8); // This fills new char place holders with
        ...
        std::string str_b{"This is a string stored in B and it's really great "
    ...
    }
    {
        ...
        // s pos : the position where we start searching in the std::string

        std::string string4 =
            "beer is packaged by her in beer cans around here.";
        const char *c_string2{"her"};

        size_t found_pos4 = string4.find(c_string2, 2);
        if (found_pos4 != std::string::npos) {
            std::cout << " " << c_string2
                      << " found at position : " << found_pos << std::endl;
        } else {
    ...
    }
    {
        ...
        // std::string number_str = "-34.567"; // Resulting unsigned long and
        // long long underflow
        ...
        std::cout << " sizeof(double_var) : " << sizeof(double_var2)
                  << std::endl;
    ...
    { // Copied Strings
        ...
        std::cout << " &message[0] : " << (void *)p1
                  << std::endl; // Printing the address of the string
        ...
        std::string &message_copy_ref_2 =
            message; // Copy Initialisation of References
...

    {
        ...
        std::cout << " Size of string_view : " << sizeof(std::string_view)
                  << std::endl;
        ...
        char char_array2[]{'H', 'u', 'g',
                           'e'}; // Non null terminated char array
        ...
        std::string_view sv8{
            char_array2,
            std::size(char_array2)}; // Non null terminated char array
        ...
        std::cout << " sv7 (constructed from other string_view) : " << sv7
                  << std::endl;
        std::cout << " Non null terminated string with std::string_view : "
                  << sv8 << std::endl;
        ...
        std::cout << " Original sv10 viewed string : " << c_string1
                  << std::endl;
        ...
        std::cout << " " << sv14 << " has " << std::strlen(sv14.data())
                  << " characters(s)" << std::endl;
        ...
        std::cout << " " << sv15 << " has " << std::strlen(sv15.data())
                  << " characters(s)" << std::endl;
    ...
    { // String View
        ...
        // Using string_view
        std::string_view sv{"Helloooooooooooooooooooooooooooooooooooooooooooooo"
